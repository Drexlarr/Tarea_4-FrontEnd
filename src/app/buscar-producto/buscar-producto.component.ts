...
export class BuscarProductoComponent implements OnInit {
  ...
  constructor(private bodegaService:BodegaService,private categoriaservicio: CategoriaService, private _Activatedroute: ActivatedRoute ) { }

  ngOnInit(): void {
    this.categoriaservicio.obtenerCategoria().subscribe(data => this.cat = data);
